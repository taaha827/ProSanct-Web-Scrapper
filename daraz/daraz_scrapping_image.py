...
class scraping:
    ...
    def specificextraction(self):        
        slider_div = self.soup.find_all("div",{"class":"dy_unit dy_smart_object_413859 dyother dyMonitor"})  
        child_divs=''.join(str(child_div) for child_div in slider_div)
        soup1 = BeautifulSoup(child_divs,"html.parser")
